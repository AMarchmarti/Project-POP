...
},{}],"app/scripts/info.js":[function(require,module,exports) {
var info = {
  arrayTemp: [],
  numbersFalse: [],
  numbersTrue: [],
...
function getItems() {
  ...
  this.diary.forEach(function (items) {
    items.eventos.forEach(function (event) {
      if (!_this.arrayTemp.includes(event)) {
        _this.arrayTemp.push(event);
      }
    });
  });
...
module.exports = info;
},{"../../../BBDD/diary":"../BBDD/diary.js"}],"app/scripts/phi.js":[function(require,module,exports) {
function phi(matrix) {
  var DIVIDE = matrix[1][1] * matrix[0][0] - matrix[1][0] * matrix[0][1];
  var DIVISOR = Math.sqrt((matrix[1][0] + matrix[1][1]) * (matrix[0][0] + matrix[0][1]) * (matrix[0][1] + matrix[1][1]) * (matrix[0][0] + matrix[1][0]));
  var RESULT = DIVIDE / DIVISOR;
  return RESULT;
}

module.exports = phi;
},{}],"app/scripts/index.js":[function(require,module,exports) {
'use strict'; // console.log('object :', require('./phi'));
// let table = {
//     
// }
...
},{"./info":"app/scripts/info.js","./phi":"app/scripts/phi.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","app/scripts/index.js"], null)
//# sourceMappingURL=/scripts.92d1ce75.js.map